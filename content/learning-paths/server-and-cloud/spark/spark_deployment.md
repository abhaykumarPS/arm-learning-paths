...
```
Now you can follow [this](content/learning-paths/server-and-cloud/spark/spark_deployment.md#check-that-jupyter-notebook-is-working-with-spark) to Check that Jupyter Notebook is working with spark
